...
export default function CodingStatusCard() {
  ...
  return (
    <div>
      <div className="relative  px-3 py-2 w-full max-w-lg rounded-2xl dark:bg-sidebar backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl dark:shadow-gray-900/20 hover:shadow-xl transition-all duration-300">
